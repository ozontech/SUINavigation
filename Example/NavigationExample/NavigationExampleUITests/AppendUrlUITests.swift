...
final class ActionUrlUITests: XCTestCase {
    ...
    func testLongUrl() throws {
        ...
        BoolView(app: app)
            .checkThis()
            .checkPath("BoolView/FirstView/SecondView/BoolView/FirstView/SecondView/BoolView?firstString=first1&secondNumber=1&firstString=first2&secondNumber=2")
            .tapBack()
        SecondView(app: app)
            .checkThis(number: 2)
            .tapDismiss()
        ...
        BoolView(app: app)
            .checkThis()
            .checkPath("BoolView/FirstView/SecondView/BoolView?firstString=first1&secondNumber=1")
            .tapBack()
        SecondView(app: app)
            .checkThis(number: 1)
            .tapBack()
    ...
    func testRepeatUrl() throws {
        ...
        BoolView(app: app)
            .checkThis()
            .checkPath("BoolView/FirstView/SecondView/BoolView?firstString=&secondNumber=0")
            .tapBack()
        SecondView(app: app)
            .checkThis(number: 0)
            .tapDismiss()
        ...
        BoolView(app: app)
            .checkThis()
            .checkPath("BoolView/FirstView/SecondView/BoolView?firstString=2&secondNumber=3")
            .tapBack()
        SecondView(app: app)
            .checkThis(number: 3)
            .tapDismiss()
    ...
    func testObjectFromParamsUrl() throws {
        let app = XCUIApplication.launchEn
        MainView(app: app)
            .checkThis()
            .checkChanging(false)
        ...
        BoolView(app: app)
            .checkThis()
            .checkPath("BoolView")
            .enterActionUrlTextField("FirstView/object?firstString=object&object.id=123&object.name=NameOfObject&object.date=2020-02-20")
            .tapAppendUrl()
        ObjectView(app: app)
            .checkThis(string: "id:123; name:NameOfObject; date:2020-02-20")
            .checkPath("BoolView/FirstView/object?firstString=object&object.id=123&object.name=NameOfObject&object.date=2020-02-20")
            .tapBack()
        FirstView(app: app)
            .checkThis(string: "object")
            .tapBack()
        BoolView(app: app)
            .checkThis()
            .tapBack()
    ...
    func testObjectFromActionUrl() throws {
        let app = XCUIApplication.launchEn
        MainView(app: app)
            .checkThis()
            .checkChanging(false)
        ...
        BoolView(app: app)
            .checkThis()
            .checkPath("BoolView")
            .enterActionUrlTextField("FirstView/ObjectView?firstString=object&object=Object: id:123; name:NameOfObject; date:2020-02-20")
            .tapAppendUrl()
        ObjectView(app: app)
            .checkThis(string: "id:123; name:NameOfObject; date:2020-02-20")
            .checkPath("BoolView/FirstView/ObjectView?firstString=object&object=Object: id:123; name:NameOfObject; date:2020-02-20")
            .tapBack()
        FirstView(app: app)
            .checkThis(string: "object")
            .tapBack()

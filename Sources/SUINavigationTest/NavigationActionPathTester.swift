...
class NavigationActionPathTester: NavigationActionPathProtocol {
    ...
    func popStringParam(_ name: String) -> String? {
        params.append(NavigationNodeParameter(name: name, type: .string, defaultValue: ""))
        return ""
    }
    ...
    func popIntParam(_ name: String) -> Int?{
        params.append(NavigationNodeParameter(name: name, type: .int, defaultValue: "0"))
        return 0
    }
    ...
    func popParam<T: NavigationParameterValue>(_ name: String) -> T?{
        ...
        params.append(NavigationNodeParameter(name: name, type: .int, defaultValue: result.stringValue))
        return result
    }
